...
export function CommandPalette() {
  ...
  const items: CommandItem[] = useMemo(() => {
    const all: CommandItem[] = [
      ...
      { id: "system", label: "Go to System Health", path: "/system", icon: Activity, action: () => navigate("/system"), keywords: ["health", "pipeline", "status", "admin", "circuits", "replica", "mv refresh", "ops"] },
      { id: "rules-tuning", label: "Rule tuning insights", path: "/rules", icon: Shield, action: () => navigate("/rules"), keywords: ["false positive", "feedback", "tuning", "correlation", "detection"] },
